...
@user1 @web
Scenario: Como admninistrador de ghost inicio sesión con datos correctos, creo un nuevo post publico y elimino un post
  ...
  And I wait for 1 seconds
  And I click on the delete post button
  And I wait for 1 seconds
  And I click on the post delete confirmation
  And I wait for 1 seconds
  And I wait for 2 seconds
  And I navigate to page "http://localhost:2368/ghost/#/posts"
  And I wait for 2 seconds
